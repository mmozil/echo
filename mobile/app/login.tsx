  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.container}>
      <View style={styles.inner}>
        ...
        >
          {loading ? <ActivityIndicator color={c.snow} /> : (
...
const criarEstilos = (c: Paleta) => StyleSheet.create({
  container: { flex: 1, backgroundColor: c.snow },
  ...
  title: { ...tipo.titulo1, color: c.ink, letterSpacing: -0.5, marginBottom: espaco.micro },
  subtitle: { ...tipo.nota, color: c.slate, marginBottom: espaco.ar },
  label: { ...tipo.legenda, fontWeight: '600', color: c.charcoal, marginBottom: espaco.micro },
  input: {
  ...
  btnText: { ...tipo.destaque, color: c.snow },
});
